...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.76159916E12, "maxY": 1.2960000000000003, "series": [{"data": [[1.76159916E12, 1.0575000000000012]], "isOverall": false, "label": "3. User Authentication - Login", "isController": false}, {"data": [[1.76159916E12, 1.2960000000000003]], "isOverall": false, "label": "2. Public Endpoints - Events List", "isController": false}, {"data": [[1.76159916E12, 1.0]], "isOverall": false, "label": "1. Health Check", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76159916E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 2.7727272727272734, "minX": 1.0, "maxY": 9.625000000000002, "series": [{"data": [[2.0, 4.755208333333333], [4.0, 8.107843137254902], [1.0, 3.6383526383526394], [5.0, 9.625000000000002], [3.0, 6.672199170124479], [6.0, 8.272727272727272]], "isOverall": false, "label": "GET /events", "isController": false}, {"data": [[1.5932000000000002, 4.429199999999996]], "isOverall": false, "label": "GET /events-Aggregated", "isController": false}, {"data": [[4.0, 2.7727272727272734], [5.0, 3.1818181818181817], [3.0, 3.769230769230769], [6.0, 4.0]], "isOverall": false, "label": "GET /health", "isController": false}, {"data": [[3.840000000000001, 3.2800000000000007]], "isOverall": false, "label": "GET /health-Aggregated", "isController": false}, {"data": [[4.0, 9.620000000000003], [2.0, 5.752941176470589], [1.0, 4.666666666666667], [5.0, 9.6], [3.0, 8.273809523809522], [6.0, 8.333333333333334]], "isOverall": false, "label": "POST /login", "isController": false}, {"data": [[2.5200000000000014, 6.824999999999999]], "isOverall": false, "label": "POST /login-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 6.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 6846.666666666667, "minX": 1.76159916E12, "maxY": 13783.333333333334, "series": [{"data": [[1.76159916E12, 13783.333333333334]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.76159916E12, 6846.666666666667]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76159916E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 3.2800000000000007, "minX": 1.76159916E12, "maxY": 6.824999999999999, "series": [{"data": [[1.76159916E12, 4.429199999999996]], "isOverall": false, "label": "GET /events", "isController": false}, {"data": [[1.76159916E12, 3.2800000000000007]], "isOverall": false, "label": "GET /health", "isController": false}, {"data": [[1.76159916E12, 6.824999999999999]], "isOverall": false, "label": "POST /login", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76159916E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 3.199999999999999, "minX": 1.76159916E12, "maxY": 6.802499999999998, "series": [{"data": [[1.76159916E12, 4.412399999999997]], "isOverall": false, "label": "GET /events", "isController": false}, {"data": [[1.76159916E12, 3.199999999999999]], "isOverall": false, "label": "GET /health", "isController": false}, {"data": [[1.76159916E12, 6.802499999999998]], "isOverall": false, "label": "POST /login", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76159916E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.026400000000000007, "minX": 1.76159916E12, "maxY": 0.3799999999999998, "series": [{"data": [[1.76159916E12, 0.026400000000000007]], "isOverall": false, "label": "GET /events", "isController": false}, {"data": [[1.76159916E12, 0.3799999999999998]], "isOverall": false, "label": "GET /health", "isController": false}, {"data": [[1.76159916E12, 0.12249999999999987]], "isOverall": false, "label": "POST /login", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76159916E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.76159916E12, "maxY": 83.0, "series": [{"data": [[1.76159916E12, 83.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.76159916E12, 1.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.76159916E12, 7.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.76159916E12, 10.0]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.76159916E12, 4.0]], "isOverall": false, "label": "Median", "isController": false}, {"data": [[1.76159916E12, 8.0]], "isOverall": false, "label": "95th percentile", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76159916E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 3.0, "minX": 46.0, "maxY": 9.0, "series": [{"data": [[266.0, 4.0], [293.0, 7.0], [326.0, 4.0], [342.0, 4.0], [339.0, 4.0], [46.0, 3.0], [387.0, 5.0], [246.0, 4.0], [251.0, 3.0], [254.0, 3.0], [250.0, 3.0]], "isOverall": false, "label": "Successes", "isController": false}, {"data": [[266.0, 5.0], [293.0, 9.0], [326.0, 5.0], [342.0, 6.0], [339.0, 6.0], [387.0, 6.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 387.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 3.0, "minX": 46.0, "maxY": 9.0, "series": [{"data": [[266.0, 3.0], [293.0, 7.0], [326.0, 4.0], [342.0, 4.0], [339.0, 4.0], [46.0, 3.0], [387.0, 5.0], [246.0, 4.0], [251.0, 3.0], [254.0, 3.0], [250.0, 3.0]], "isOverall": false, "label": "Successes", "isController": false}, {"data": [[266.0, 5.0], [293.0, 9.0], [326.0, 5.0], [342.0, 6.0], [339.0, 6.0], [387.0, 6.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 387.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 50.0, "minX": 1.76159916E12, "maxY": 50.0, "series": [{"data": [[1.76159916E12, 50.0]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76159916E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 6.666666666666667, "minX": 1.76159916E12, "maxY": 43.333333333333336, "series": [{"data": [[1.76159916E12, 43.333333333333336]], "isOverall": false, "label": "200", "isController": false}, {"data": [[1.76159916E12, 6.666666666666667]], "isOverall": false, "label": "401", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76159916E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 1.6666666666666667, "minX": 1.76159916E12, "maxY": 41.666666666666664, "series": [{"data": [[1.76159916E12, 41.666666666666664]], "isOverall": false, "label": "GET /events-success", "isController": false}, {"data": [[1.76159916E12, 6.666666666666667]], "isOverall": false, "label": "POST /login-failure", "isController": false}, {"data": [[1.76159916E12, 1.6666666666666667]], "isOverall": false, "label": "GET /health-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76159916E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 6.666666666666667, "minX": 1.76159916E12, "maxY": 43.333333333333336, "series": [{"data": [[1.76159916E12, 43.333333333333336]], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [[1.76159916E12, 6.666666666666667]], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76159916E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
