...
import SeatRenderer from './SeatRenderer'; // el componente común arriba
...
const footballConfig = {
  ...
  sections: [
    { id: 'tribuna-norte', name: 'Tribuna Norte', rows: 10, seatsPerRow: 15, price: 50000, color: '#4CAF50' },
    { id: 'tribuna-este', name: 'Tribuna Este', rows: 8, seatsPerRow: 12, price: 75000, color: '#2196F3' },
    { id: 'tribuna-oeste', name: 'Tribuna Oeste', rows: 8, seatsPerRow: 12, price: 75000, color: '#2196F3' },
    { id: 'tribuna-sur', name: 'Tribuna Sur', rows: 10, seatsPerRow: 15, price: 50000, color: '#4CAF50' },
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 30, minWidth: 800, minHeight: 600 }}>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <Card style={{ padding: 10, margin: 5 }}>
          <SeatRenderer
            ...
            sectionId={sections[0].id} // ID único de la sección
          />
        </Card>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', gap: 40 }}>
        ...
        <Card style={{ padding: 8, borderRadius: 8 }}>
            <SeatRenderer
            {...sections[2]}
            selectedSeats={selectedSeats}
            occupiedSeats={occupiedSeats}
            ...
            onSeatSelect={onSeatSelect}
            formatPrice={formatPrice}
            sectionId={sections[2].id} // ID único de la sección
            />
        </Card>
        </div>
        ...
        <Card style={{ padding: 8, borderRadius: 8 }}>
            ...
            onSeatSelect={onSeatSelect}
            formatPrice={formatPrice}
            sectionId={sections[3].id} // ID único de la sección
            />
        </Card>
        </div>
      </div>
      ...
      <div style={{ textAlign: 'center' }}>
        <Card style={{ padding: 10, margin: 5 }}>
          <SeatRenderer
            ...
            onSeatSelect={onSeatSelect}
            formatPrice={formatPrice}
            sectionId={sections[1].id} // ID único de la sección
          />
        </Card>
        <Text strong>{sections[1].name}</Text>
      </div>
      ...
      <div style={{ textAlign: 'center', marginTop: 20 }}>
        ...
        <Card style={{ border: '2px solid #FF9800', padding: 10, borderRadius: 8, margin: 5, backgroundColor: '#FFF3E0' }}>
          <SeatRenderer
            ...
            onSeatSelect={onSeatSelect}
            formatPrice={formatPrice}
            sectionId={sections[4].id} // ID único de la sección
          />
        </Card>
      </div>
    </div>
