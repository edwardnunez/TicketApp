/* 
 * Esquema de colores para TicketApp
 */

// Colores principales
const PRIMARY = {
  main: '#00BFA5', // Verde menta (principal)
  light: '#5DF2D6',
  dark: '#008E76',
};
...
// Colores de categorías (manteniendo el contraste pero con el estilo menta)
const CATEGORIES = {
  conciertos: '#00ACC1', // Cian que combina con menta
